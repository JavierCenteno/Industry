...
import typeobject.Ideology.BeliefSet;
import typeobject.KnowledgeField.SkillSet;
import typeobject.Occupation;
import typeobject.Sickness;
...
public class Citizen extends GameObject {
	...
	static {
		// i18n
		final Json i18n = Industry.I18N.get("gameObject", "citizen");
		...
		// data
		final Json data = Industry.DATA.get("gameObject", "citizen");
