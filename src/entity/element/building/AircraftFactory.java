...
import entity.element.building.category.Tertiary;
...
public class AircraftFactory extends Building implements Tertiary {
	...
	static {
		// i18n
		final Json i18n = Industry.I18N.get("entity", "element", "building", "list", "aircraftFactory");
		...
		// data
		final Json data = Industry.DATA.get("entity", "element", "building", "list", "aircraftFactory");
