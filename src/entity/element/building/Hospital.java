...
import entity.element.building.category.PublicHealth;
...
public class Hospital extends Building implements PublicHealth {
	...
	static {
		// i18n
		final Json i18n = Industry.I18N.get("entity", "element", "building", "list", "hospital");
		...
		HospitalWorkmode.UNIVERSITY_HOSPITAL.description = i18n.get("workmodes", "universityHospital", "description")
				.as(String.class);
		// data
		final Json data = Industry.DATA.get("entity", "element", "building", "list", "hospital");
