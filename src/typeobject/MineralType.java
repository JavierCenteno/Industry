 ...
 *
 */
public class MineralType extends TypeObject {
	...
	static {
		...
		final Json i18n = Industry.I18N.get("typeObject", "mineralType", "list");
		final Json data = Industry.DATA.get("typeObject", "mineralType", "list");
