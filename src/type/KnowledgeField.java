 ...
 *
 */
public class KnowledgeField extends Type {
	...
	static {
		...
		final Json i18n = Industry.I18N.get("type", "knowledgeField", "list");
		final Json data = Industry.DATA.get("type", "knowledgeField", "list");
