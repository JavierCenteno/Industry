...
public class Policy extends Type {
	...
	public static class Policies {
		...
		public static final Policy SUCCESSION_LAW = Policy.getPolicy("successionLaw");
	...
	static {
		...
		final Json i18n = Industry.I18N.get("type", "policy", "list");
		final Json data = Industry.DATA.get("type", "policy", "list");
