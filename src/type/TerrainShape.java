 ...
 *
 */
public class TerrainShape extends Type {
	...
	static {
		...
		final Json i18n = Industry.I18N.get("type", "terrainShape", "list");
		final Json data = Industry.DATA.get("type", "terrainShape", "list");
